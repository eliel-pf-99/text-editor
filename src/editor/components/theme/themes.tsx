...
export default function themes(props: ThemesProps) {
  ...
  return (
    <div title="set theme" tabIndex={0} onBlur={handleOnBlur} className="relative outline-none transition-all hover:border rounded-full p-1 flex items-center flex-col">
